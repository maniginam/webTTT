...
(describe "HTML Transcriber"
	...
	(context "draws game in play"
		(it "computer vs computer cat's game"
			...
			(let [response-body-lines (str/split (:body (client/get "http://localhost:2021/ttt/playing")) #"\n")]
				...
				(should-contain "<line x1=\"41.0%\" y1=\"11.0%\" x2=\"59.0%\" y2=\"29.0%\" stroke=\"coral\" stroke-width=\"30\" stroke-linecap=\"round\"/>" response-body-lines)
				(should-contain "<line x1=\"59.0%\" y1=\"11.0%\" x2=\"41.0%\" y2=\"29.0%\" stroke=\"coral\" stroke-width=\"30\" stroke-linecap=\"round\"/>" response-body-lines)
